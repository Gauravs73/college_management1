...
public class ChatData {
	...
	{
		int total=0;
		String course=s.getCourceCode()+" "+new CourceData().getsemoryear(s.getCourceCode())+"-"+s.getSemorYear();
		try
		{
	...
	{
		int total=0;
		String course=f.getCourceCode()+" "+new CourceData().getsemoryear(f.getCourceCode())+"-"+f.getSemorYear();
		try
		{
