...
public class SearchPanel extends JPanel implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==courcenamecombo)
		{
			...
			else
			{
			 ...
			 String semoryear[]=new CourceData().getSemorYear(course);
	...
	public void createtablemodel()
	{
		...
		if(studentandfacultycombo.getSelectedIndex()==0)
		{
			String defaultquery="select s.courcecode as 'Class' ,s.rollnumber as 'Roll Number',concat(s.firstname,' ',s.lastname) as 'Student Name',c.courcename as 'Course Name',concat(c.semoryear,'-',s.semoryear) as 'Sem/Year' from students s left join courses c on s.courcecode=c.courcecode ";
